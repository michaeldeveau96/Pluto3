...
def get_average_ping(self):
    ...
    average_ping = round(sum(pings) / len(pings))
    end = time.time()
    ptime = end - start
...
def get_average_download(self):
    ...
    average_download = round(sum(downloads) / len(downloads))
    end = time.time()
    ptime = end - start
    print('Calculated average download. Finished in {} seconds.'.format(ptime))
    print('====================================================')
    return average_download
...
def get_average_upload(self):
    ...
    average_upload = round(sum(uploads) / len(uploads))
    end = time.time()
    ptime = end - start
